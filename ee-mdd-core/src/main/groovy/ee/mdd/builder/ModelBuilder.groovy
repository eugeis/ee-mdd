...
class ModelBuilder extends AbstractFactoryBuilder {
  ...
  void registerAll() {
    ...
    def counter = new CompositeFactory(beanClass: Count, childFactories: ['param'], parent: dataTypeOperation)
    def create = new CompositeFactory(beanClass: Create, parent: dataTypeOperation)
    def delete = new CompositeFactory(beanClass: Delete, childFactories: ['param'], parent: dataTypeOperation)
    ...
    def exist = new CompositeFactory(beanClass: Exist, childFactories: ['param'], parent: dataTypeOperation)
    def externalType = new CompositeFactory(beanClass: ExternalType, parent: type)
    def facet = new CompositeFactory(beanClass: Facet)
    def finder = new CompositeFactory(beanClass: Find, childFactories: ['param'], parent: dataTypeOperation)
