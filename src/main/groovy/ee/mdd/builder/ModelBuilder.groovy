...
class ModelBuilder extends AbstractFactoryBuilder {
  ...
  void registerAll() {
    ...
    def factoryEntity = new CompositeFactory(beanClass: Entity, childFactories: ['prop', 'op'])
    ...
    def factoryModule = new CompositeFactory(beanClass: Module, childFactories: ['facet', 'entity', 'basicType', 'enumType', 'pojo', 'config', 'extType'])
