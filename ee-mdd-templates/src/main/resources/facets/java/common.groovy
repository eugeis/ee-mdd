...
def nameToNamespace = ['Comparator' : 'java.util', 'Date': 'java.util', 'List' : 'java.util', 'Map' : 'java.util', 'Set' : 'java.util', 'ArrayList' : 'java.util',
  ...
  'Proxy' : 'java.lang.reflect', 'Arrays' : 'java.util', 'AtomicLong' : 'java.util.concurrent.atomic', 'AtominInteger' : 'java.util.concurrent.atomic', 'mock' : 'static org.mockito.Mockito.*'] as TreeMap
