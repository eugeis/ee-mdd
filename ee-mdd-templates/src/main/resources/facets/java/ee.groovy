...
extModule(name: 'EeCommonBase', artifact: 'ee-common-base') {
  ...
  'TempIdCache' : 'ee.common.cache', 'Cache' : 'ee.common.cache', 'LinkToSetCache' : 'ee.common.cache', 'LinkToSet' : 'ee.common.model', 'Model' : 'ee.common.annotations', 'RootScoped' : 'ee.common.annotations'].each { n, ns ->
