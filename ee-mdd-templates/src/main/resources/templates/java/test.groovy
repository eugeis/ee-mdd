...
import static ee.mdd.generator.OutputPurpose.UNIT_TEST
...
templates('test', purpose: UNIT_TEST) {
  ...
  items: { c -> c.model.findAllDown(ee.mdd.model.component.StateMachine) },
  ...
  items: { c -> c.model.findAllDown(ee.mdd.model.component.Condition) },
  context: { c -> c.putAll( [ component: c.item.component, module: c.item.module, subPkg: 'statemachine'] ) } ) {
  ...
  items: { c -> c.model.findAllDown(ee.mdd.model.component.View) },
  context: { c -> c.putAll( [ component: c.item.component, module: c.item.module] ) } ) {
